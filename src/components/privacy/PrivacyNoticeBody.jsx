...
export default function PrivacyNoticeBody({ className = '' }) {
  return (
    <article className={['space-y-6 text-gray-700', className].filter(Boolean).join(' ')}>
      <div>
        <h2 className="privacy-heading uppercase text-black">Aviso de privacidad</h2>
        <p className="mt-3 privacy-body">
          En Example Insurance reconocemos la importancia de la seguridad, la privacidad y la
      ...
      <p className="privacy-body">
        ...
        términos y condiciones que emplea Example Insurance en el tratamiento y Protección de sus datos
      ...
      <div className="space-y-3">
        ...
        <p className="privacy-body">
          ...
          cualquier otra índole, que Example Insurance sostenga con todas las personas con las que se
          relaciona, en el giro de cualquiera de estas actividades, Example Insurance obtiene de su titular
      ...
      <div className="space-y-3">
        ...
        <p className="privacy-body">
          Example Insurance, de acuerdo a la Ley 81 sobre Protección de Datos Personales, y en virtud de la
      ...
      <div className="space-y-3">
        ...
        <p className="privacy-body">
          Los datos personales que Example Insurance obtiene de su titular podrán ser compartidos o de
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li className="privacy-body">
            ...
            productos o servicios que Example Insurance le presta u ofrece.
          </li>
          <li className="privacy-body">
          ...
          <li className="privacy-body">
            ...
            personales en la prestación de los productos y servicios con Example Insurance, incluyendo la
          ...
          <li className="privacy-body">
            Gestionar los riesgos a los cuales Example Insurance está expuesto en el desarrollo de sus
            negocios.
          </li>
          <li className="privacy-body">
          ...
          <li className="privacy-body">
            Obtener, a través de terceros, incluyendo entidades del Grupo, servicios, recursos y
            capacidades; incluyendo capacidades tecnológicas, uso de redes, de alojamiento,
            almacenamiento, procesamiento y analítica de datos, así como servicios financieros, de
            asesoría, auditoría, calificación de riesgos, administrativos, operativos y contables, entre
            otros; que permiten o facilitan el ofrecimiento de los servicios a su favor.
          </li>
          <li className="privacy-body">
            Obtener la colaboración empresarial de las empresas del Grupo, para la ejecución de las
            actividades propias de nuestro negocio.
          </li>
          <li className="privacy-body">
            El ejercicio de los derechos de Example Insurance, incluyendo el proceso administrativos,
          ...
          <li className="privacy-body">
            ...
            modelo de negocio y oferta de servicios de Example Insurance, lo cual podrá implicar la
            transmisión o transferencia de los datos personales a entidades del Grupo y/o terceros.
          </li>
          <li className="privacy-body">
            Cualquier otra finalidad requerida para el desarrollo del objeto social de Example Insurance y
          ...
          <li className="privacy-body">Desarrollo y optimización de productos, servicios y canales.</li>
          <li className="privacy-body">
            Obtener, consultar, reportar, rectificar, modificar y eliminar el historial o antecedentes
            de créditos, ante centrales de riesgo o agencias de información.
          </li>
          <li className="privacy-body">
          ...
          <li className="privacy-body">
            ...
            comercial, reputacional, el cumplimiento de sus obligaciones, la imposición de multas y
            sanciones, en otras entidades, tanto del Grupo como no vinculadas, incluyendo
            operadores de información o proveedores de bases de datos.
          </li>
          <li className="privacy-body">
            ...
            web, plataformas y/o aplicativos tecnológicos y/o digitales de Example Insurance, incluyendo el uso
            de cookies propias y de terceros.
          </li>
          <li className="privacy-body">
            Compartirla con aliados estratégicos, para que estos puedan ofrecerle beneficios y
            servicios asociados a los productos y servicios de Example Insurance; con entidades del Grupo,
            ...
            cumplir con regulaciones que le sean aplicables, gestionar riesgos, y prevenir el uso
            indebido de sus productos y servicios, a nivel individual o consolidado.
          </li>
          <li className="privacy-body">
          ...
          <li className="privacy-body">
            ...
            datos personales no apliquen estándares equivalentes a los de Example Insurance en materia de
            protección de datos personales.
          </li>
          <li className="privacy-body">
            Realizar encuestas de satisfacción concerniente a los servicios prestados por Example Insurance.
          </li>
          <li className="privacy-body">
            ...
            sistemas interoperables, cuando no exista otra base legítima para hacerlo; en virtud de
            ecosistemas de información abierta.
          </li>
          <li className="privacy-body">
            Compartir información con terceros, tales como auditores, asesores, consultores,
            contrapartes, aliados, proveedores, calificadoras y corresponsales, cuando lo requieran en
            el contexto de la ejecución de una transacción o la prestación de servicios financieros, de
            asesoría o corresponsalía a nuestro favor, con autoridades locales o extranjeras, cuando
            sea requerida en el contexto de investigaciones y acciones relacionadas con la
            prevención del blanqueo de capitales, financiamiento del terrorismo, y cualquier otra
            actividad ilícita, basado en una norma extranjera con aplicación extraterritorial.
          </li>
          <li className="privacy-body">
            Obtención y procesamiento de datos sensibles, para todas las finalidades enunciadas en
            esta sección.
          </li>
          <li className="privacy-body">
            Compartir información con terceros, a solicitud del propio titular de datos personales o su
            representante autorizado.
          </li>
        </ul>
        <p className="privacy-body">Para fines compatibles con los anteriores.</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <p className="privacy-body">
          ...
          comunicación que el titular utilice para contactarse con la organización, ya sea de manera
          física o digital, o cualquier otro medio que la organización habilite para tales efectos.
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <p className="privacy-body">
          ...
          cual, los datos sensibles que recopilemos, mediante fotos, imágenes, videos, voz o
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li className="privacy-body">
            Cuando sea necesario para salvaguardar la vida del titular y este se encuentre física o
            jurídicamente incapacitado, para lo cual los acudientes, curadores o quienes tengan la
            tutela, deberán otorgar la autorización.
          </li>
          <li className="privacy-body">
            Cuando se refiera a datos que sean necesarios para el reconocimiento, ejercicio o defensa
            de un derecho con autorización judicial competente.
          </li>
          <li className="privacy-body">
            Cuando tenga una finalidad histórica, estadística o científica. En este caso, deberán
            adoptarse las medidas conducentes a disociar la identidad de los titulares.
          </li>
          <li className="privacy-body">
            En el caso de menores de edad o personas con discapacidades legales, se entenderá que el
            consentimiento será dado por el adulto o persona responsable.
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-3">
        ...
        <p className="privacy-body">
          Example Insurance, dependiendo del producto o servicio, conservará y tratará sus datos personales,
      ...
      <div className="space-y-3">
        ...
        <p className="privacy-body">
          Las condiciones del presente aviso estarán vigentes a partir de su publicación, y Example Insurance se
      ...
      <div className="space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li className="privacy-body">
            ...
            indicar antecedentes, como la pertenencia de la persona natural a una organización, su
            profesión o actividad, sus títulos educativos dirección o fecha de nacimiento.
          </li>
          <li className="privacy-body">
          ...
          <li className="privacy-body">
            Cuando sea necesario para la aplicación de contratos en Example Insurance en los que el titular de
          ...
          <li className="privacy-body">
            ...
            exclusivo de sus asociados y de las entidades a que se están afiliadas, con fines
            estadísticos, de tarificación u otros de beneficio general de aquellos.
          </li>
          ...
          <li className="privacy-body">
            ...
            por el responsable del tratamiento o por un tercero, siempre que sobre dichos interese no
            prevalezcan los interese a los derechos y libertades fundamentales del interesado que
            requieran la protección de datos personales, en particular cuando el interesado sea menor
            de edad o una persona con discapacidad.
          </li>
          <li className="privacy-body">
          ...
          <li className="privacy-body">
            ...
            y las instalaciones de Example Insurance.
          </li>
          <li className="privacy-body">
            Cuando el tratamiento sea necesario para el cumplimiento de requerimientos u
            obligaciones exigidas por el ente regulador que corresponda a Example Insurance.
          </li>
          <li className="privacy-body">
          ...
          <li className="privacy-body">
            Cuando los datos sean utilizados o compartidos por Example Insurance, con la propietaria de acciones
          ...
          <li className="privacy-body">
            Cuando el tratamiento esté basado en un interés legítimo de Example Insurance derivado de la
            relación o vínculo existente con el titular de datos personales, por razón de un producto o
            servicio de Example Insurance.
          </li>
          <li className="privacy-body">
            ...
            Example Insurance o a terceros par la gestión de la relación contractual Example Insurance-titular de datos
            personales, siempre que sea relacionado para con la prestación de un servicio o producto de
            Example Insurance y de mercadeo.
          </li>
          <li className="privacy-body">
        ...
        <p className="privacy-body">
          ...
          comercial o de mercadeo sobre productos o servicios de Example Insurance requerirá de su
      ...
      <div className="space-y-3">
        ...
        <p className="privacy-body">
          ...
          Example Insurance, éstos comprenden los derechos a acceso, rectificación, cancelación, oposición y
          portabilidad (ARCO).
        </p>
        <p className="privacy-body">
          ...
          gratuito de la atención de estos requerimientos podrá tener las limitaciones que establezcan
          las normas aplicables a la materia. El derecho de los titulares de datos personales a la
          atención de estos requerimientos es irrenunciable y solo podrá ser limitado por norma.
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <p className="privacy-body">
          ...
          presentar ante Example Insurance, como responsable del tratamiento de los datos, toda solicitud,
          reclamación, queja y controversia vinculada con la protección de datos personales.
        </p>
        <p className="privacy-body">
          En caso de que Example Insurance no cumpla con atender la solicitud concerniente al ejercicio de los
          Derechos ARCO o el titular de datos personales se encuentre disconforme con la decisión
          adoptada por Example Insurance, el mismo podrá interponer un reclamo ante su ente regulador. Para
          tales fines, el titular de datos personales tendrá un plazo de 30 días calendario, los cuales
          empezarán a regir a partir de la fecha en que obtuvo respuesta formal por parte de Example Insurance
          o cuando no hayamos cumplido con resolver la solicitud o reclamo en el plazo
          correspondiente.
        </p>
        <p className="privacy-body">Entes Reguladores:</p>
        <ul className="list-disc space-y-2 pl-6">
          <li className="privacy-body">Example Insurance, S.A.: Superintendencia de Bancos de Panamá</li>
          <li className="privacy-body">Example Insurance Investment Corporation, S.A.: Superintendencia de Bancos de Panamá</li>
          <li className="privacy-body">Leasing Example Insurance, S.A.: Superintendencia de Bancos de Panamá</li>
          <li className="privacy-body">Valores Example Insurance, S.A.: Superintendencia de Valores de Panamá</li>
        </ul>
      </div>
    </article>
  )
