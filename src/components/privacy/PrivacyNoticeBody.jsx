    ...
    <article className={['space-y-6 text-gray-700', className].filter(Boolean).join(' ')}>
      ...
      <div className="space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li className="privacy-body">
            El ejercicio de los derechos de Banistmo, incluyendo el proceso administrativos,
          ...
          <li className="privacy-body">
            ...
            web, plataformas y/o aplicativos tecnológicos y/o digitales de Banistmo, incluyendo el uso
            de cookies propias y de terceros.
          </li>
          <li className="privacy-body">
            Compartirla con aliados estratégicos, para que estos puedan ofrecerle beneficios y
            servicios asociados a los productos y servicios de Banistmo; con entidades del Grupo,
          ...
          <li className="privacy-body">
            ...
            datos personales no apliquen estándares equivalentes a los de Banistmo en materia de
      ...
      <div className="space-y-3">
        ...
        <p className="privacy-body">
          Las condiciones del presente aviso estarán vigentes a partir de su publicación, y Banistmo se
      ...
      <div className="space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li className="privacy-body">
            ...
            y las instalaciones de Banistmo.
          </li>
          <li className="privacy-body">
          ...
          <li className="privacy-body">
            Cuando los datos sean utilizados o compartidos por Banistmo, con la propietaria de acciones
          ...
          <li className="privacy-body">
            ...
            Banistmo o a terceros par la gestión de la relación contractual Banistmo-titular de datos
            personales, siempre que sea relacionado para con la prestación de un servicio o producto de
            Banistmo y de mercadeo.
          </li>
          <li className="privacy-body">
      ...
      <div className="space-y-3">
        ...
        <p className="privacy-body">
          ...
          presentar ante Banistmo, como responsable del tratamiento de los datos, toda solicitud,
        ...
        <p className="privacy-body">
          ...
          empezarán a regir a partir de la fecha en que obtuvo respuesta formal por parte de Banistmo
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li className="privacy-body">Banistmo Investment Corporation, S.A.: Superintendencia de Bancos de Panamá</li>
